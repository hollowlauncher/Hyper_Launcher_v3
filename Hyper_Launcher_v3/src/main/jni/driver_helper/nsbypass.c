...
void* linker_dlopen_unique_impl(const char* tmpdir, const char* name, const char* patch_name, int flags, struct android_namespace_t* ns);
...
void* linker_ns_dlopen_unique(const char* tmpdir, const char* name, const char* patch_name, int flags) {
    return linker_dlopen_unique_impl(tmpdir, name, patch_name, flags, driver_namespace);
}

void* linker_dlopen_unique_global(const char* tmpdir, const char* name, const char* patch_name, int flags) {
    return linker_dlopen_unique_impl(tmpdir, name, patch_name, flags, NULL);
}
