...
public class ModItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements TaskCountListener {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private AutoCompleteTextView mExtendedSpinner;
            ...
            view.setOnClickListener(v -> {
                if(!hasExtended()){
                    ...
                    mExtendedButton.setOnClickListener(v1 -> mModpackApi.handleModpackInstallation(
                            ...
                            mModDetail,
                            mVersionAdapter.getSelectedIndex()));
                    mExtendedSpinner.setAdapter((ListAdapter & Filterable) mLoadingAdapter);
                    mExtendedSpinner.setOnClickListener(v1 -> mExtendedSpinner.showDropDown());
                    mExtendedSpinner.setOnItemClickListener((parent, v1, position, id) -> mVersionAdapter.setSelectedIndex(position));
                } else {
        ...
        private void setStateDetailed(ModDetail detailedItem) {
            if(detailedItem != null) {
                ...
                mExtendedSpinner.setAdapter((ListAdapter & Filterable) mVersionAdapter);
            } else {
                closeDetailedView();
